...
def create_app(skip_db_init: bool = False, *, serve_frontend: bool = True) -> FastAPI:
    ...
    app = FastAPI(
        ...
        "Tracks W-2 paychecks, 1099-R pension income, and non-taxable income (non-taxable benefit, etc.) "
        ...
        openapi_tags=[
            {
                ...
                "and non-taxable income (non-taxable benefit, SSA, gifts). Supports CSV bulk import.",
            },
            {
                "name": "Taxes",
