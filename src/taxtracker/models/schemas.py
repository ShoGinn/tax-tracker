...
class Retirement1099RBase(BaseModel):
    ...
    source_description: str | None = Field(
        default=None, description="Source of income (e.g., 'Retirement distribution', '401k Distribution')"
    )
    notes: str | None = None
...
class NonTaxableIncomeBase(BaseModel):
    ...
    source_type: str | None = Field(default=None, description="Income source (e.g., 'Non-taxable benefit', 'SSA Disability')")
    notes: str | None = None
