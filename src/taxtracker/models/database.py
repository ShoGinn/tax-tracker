...
class Retirement1099R(Base):
    ...
    # Source description (e.g., "Military Pension", "401k Distribution")
...
class NonTaxableIncome(Base):
    """Non-taxable income (VA disability, SSA disability, child support, gifts).
    ...
    # Example values: "VA Disability", "SSA Disability", "Child Support"
